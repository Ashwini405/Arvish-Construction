...
const WarehouseHeroSVG = () => (
  <svg viewBox="0 0 1200 680" preserveAspectRatio="xMinYMid slice" xmlns="http://www.w3.org/2000/svg" className="w-full h-full object-cover">
    <defs>
  ...
  return (
    <>
      ...
      <div className="min-h-screen overflow-hidden bg-white" style={{ fontFamily: "'Inter', system-ui, sans-serif", color: '#1e293b' }}>
        ...
        {/* ── HERO ── */}
        <section className="relative flex flex-col justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-amber-50" style={{ minHeight: 'min(100vh, 800px)' }}>
          <div className="absolute inset-0 opacity-85 sm:opacity-90 flex items-stretch justify-stretch">
            <div className="absolute inset-0 w-full h-full overflow-hidden">
              <WarehouseHeroSVG />
            </div>
          </div>
          <div className="absolute bottom-0 left-0 right-0 h-32 sm:h-40 bg-gradient-to-t from-white via-white/80 to-transparent" />
          <div className="absolute top-0 left-0 right-0 h-20 sm:h-24 bg-gradient-to-b from-white/60 to-transparent" />

          <div className="relative z-10 container mx-auto px-4 sm:px-6 pt-16 sm:pt-20 md:pt-24 pb-12 sm:pb-16 md:pb-20">
            {/* Eyebrow */}
            <div className="inline-flex items-center gap-2 bg-white/85 backdrop-blur border border-slate-200 rounded-full px-3 sm:px-4 py-1.5 mb-6 sm:mb-8 shadow-sm text-xs">
              <div className="w-1.5 h-1.5 rounded-full bg-amber-400" />
              <span className="font-medium tracking-widest text-slate-500 uppercase hidden sm:inline text-xs">Telangana · Industrial · Ongoing</span>
              <span className="font-medium tracking-widest text-slate-500 uppercase sm:hidden text-xs">Telangana</span>
            </div>

            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-slate-900 mb-2 sm:mb-4 leading-tight sm:leading-tight tracking-tight">
              Industrial<br />
              <span className="text-amber-500">Warehouse</span>
            </h1>
            <p className="text-xs sm:text-sm font-medium text-amber-600 tracking-widest mb-4 sm:mb-5 uppercase">Pre-Engineered Steel Structure</p>

            <p className="text-sm sm:text-base text-slate-600 max-w-xl mb-8 sm:mb-10 leading-relaxed">
            ...
            {/* Status pill */}
            <div className="inline-flex items-center gap-2 sm:gap-3 bg-amber-50 border border-amber-200 rounded-full px-3 sm:px-5 py-1.5 sm:py-2.5 shadow-sm text-xs sm:text-sm">
              <span className="relative flex h-2 w-2 flex-shrink-0">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-amber-400 opacity-75" />
                <span className="relative inline-flex rounded-full h-2 w-2 bg-amber-500" />
              </span>
              <span className="text-amber-700 font-semibold tracking-wide">Under Construction — 68% Complete</span>
            </div>
          </div>
        </section>

        {/* ── COUNTERS ── */}
        <section className="py-6 sm:py-8 border-y border-slate-100 bg-white">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-0 sm:divide-x divide-slate-100">
              {[
                ...
                <div key={label} ref={ref} className="text-center py-5 sm:py-8 px-2 sm:px-4 group">
                  <div className="text-2xl sm:text-4xl md:text-5xl font-bold text-slate-900 tabular-nums mb-1">{count.toLocaleString()}{suffix}</div>
                  ...
                  <div className="mt-2 sm:mt-3 h-0.5 w-6 sm:w-8 bg-amber-400 mx-auto group-hover:w-10 sm:group-hover:w-16 transition-all duration-500" />
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 sm:py-24 bg-slate-50">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
              {features.map((f, i) => (
                <div key={i} className="group p-5 sm:p-6 bg-white border border-slate-100 hover:border-amber-200 rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-amber-50">
                  <div className="mb-4 sm:mb-5 group-hover:scale-105 transition-transform duration-300 text-lg sm:text-xl">{f.icon}</div>
                  <h4 className="text-xs sm:text-sm font-bold text-slate-800 mb-2 tracking-wide">{f.title}</h4>
            ...
            <div className="flex flex-col lg:flex-row gap-6 sm:gap-10 lg:gap-16 items-start">
              <div className="lg:w-3/5 w-full">
                <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-xl shadow-slate-100">
                  <div className="bg-slate-50 px-3 sm:px-4 py-2 sm:py-2.5 flex items-center gap-2 border-b border-slate-200">
              ...
              <div className="lg:w-2/5 w-full lg:sticky lg:top-28">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4 sm:mb-5 leading-tight">Strategic<br /><span className="text-amber-500">Zoning</span></h2>
