...
const specs = [
  { label: 'Plot Area', value: 'Approx. 3,000 sq ft' },
  { label: 'Built-up Area', value: 'Approx. 2,500 sq ft' },
  ...
  { label: 'Parking', value: 'Covered Parking Available' },
  { label: 'Design', value: 'Modern Residential Design' },
  { label: 'Materials', value: 'Quality Construction Materials' },
      ...
      <div className="min-h-screen bg-slate-50 overflow-hidden" style={{ fontFamily: "'Cormorant Garamond', 'Garamond', Georgia, serif" }}>
        ...
        <section className="py-24 bg-[#f9f7f4]">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-3 mb-4">
                <div className="w-8 h-0.5 bg-amber-600 rounded-full"></div>
                <span className="text-xs font-bold text-amber-600 uppercase tracking-wider">Elevation Drawing</span>
                <div className="w-8 h-0.5 bg-amber-600 rounded-full"></div>
              </div>
              <h2 className="text-4xl font-bold text-stone-900 leading-tight">
                Front <span className="text-amber-600">Elevation</span>
              </h2>
            </div>
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              ...
              <div className="lg:w-3/5 w-full">
                <div className="inline-flex items-center gap-3 mb-4">
                  <div className="w-8 h-0.5 bg-amber-600 rounded-full"></div>
                  <span className="text-xs font-bold text-amber-600 uppercase tracking-wider">Project Timeline</span>
                  <div className="w-8 h-0.5 bg-amber-600 rounded-full"></div>
                </div>
                <h2 className="text-4xl font-bold text-stone-900 mb-10 leading-tight">
                  From Concept<br />to <span className="text-amber-600">Completion</span>
                </h2>
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-bold text-stone-900 leading-tight">
                Project <span className="text-blue-600">Specifications</span>
              </h2>
            </div>
        ...
        <section className="py-24 bg-[#f9f7f4]">
          <div className="container mx-auto px-6 max-w-3xl text-center">
            <div className="inline-flex items-center gap-3 mb-4">
              <div className="w-8 h-0.5 bg-amber-600 rounded-full"></div>
              <span className="text-xs font-bold text-amber-600 uppercase tracking-wider">Begin Your Project</span>
              <div className="w-8 h-0.5 bg-amber-600 rounded-full"></div>
            </div>
