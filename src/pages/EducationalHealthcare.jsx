...
// import { GraduationCap, HeartPulse, Accessibility, FlaskConical, ArrowRight, CheckCircle, Users, Building2 } from "lucide-react";
...
//     },
//     {
//       name: "College Campus Development",
//       location: "Hyderabad",
...
//   const features = [
//     { icon: GraduationCap, title: "Schools & Educational Buildings", desc: "Safe and functional learning environments designed for educational needs." },
//     { icon: HeartPulse, title: "Hospitals & Medical Facilities", desc: "Healthcare buildings constructed for patient care and operational efficiency." },
//     { icon: Accessibility, title: "Accessible Design", desc: "Facilities built with accessibility in mind for all users." },
//     { icon: FlaskConical, title: "Specialized Spaces", desc: "Laboratories and specialist rooms built to meet specific requirements." },
//   ];
...
//               <span className="text-xs font-bold text-white/80 uppercase tracking-wider">Services / Educational & Healthcare</span>
//               <div className="w-8 h-0.5 bg-white/50 rounded-full"></div>
//             </div>
...
//               We build educational institutions and healthcare facilities designed for safety, functionality, and community needs.
//             </p>
//           </motion.div>
//         </div>
//       </section>
...
//               <div className="w-8 h-0.5 bg-blue-600 rounded-full"></div>
//             </div>
//             <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Specialized Facilities</h2>
...
//               <div className="inline-flex items-center gap-3 mb-4">
//                 <div className="w-8 h-0.5 bg-blue-600 rounded-full"></div>
//                 <span className="text-xs font-bold text-blue-600 uppercase tracking-wider">Our Commitment</span>
//               </div>
//               <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
//                 Facilities Built for Community Needs
//               </h2>
//               <p className="text-gray-600 leading-relaxed mb-4">
//                 Educational and healthcare facilities carry a unique responsibility — they serve communities for generations. We approach every such project with the highest standards of safety, functionality, and long-term durability.
//               </p>
//               <p className="text-gray-600 leading-relaxed mb-8">
//                 Our teams work closely with clients to ensure every facility meets operational requirements and is built to last.
//               </p>
...
export default function EducationalHealthcare() {
  ...
  const stats = [
    ...
    { value: "12",   label: "Districts Served",  icon: GraduationCap },
  ];
            ...
            <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2.5rem", paddingTop: "12rem", width: "100%" }}>
              ...
              >
                ...
                <motion.div
                  ...
                  style={{ height: 2, background: "linear-gradient(90deg,#4ca1af,transparent)",
                    width: 200, transformOrigin: "left", marginBottom: "1.25rem" }}
                />
            ...
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "4rem", gap: "2rem" }}>
              <motion.div initial={{ opacity: 0, x: -20 }} animate={controls} variants={{ visible: { opacity: 1, x: 0, transition: { duration: 0.6 } } }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div style={{ width: 44, height: 3, background: "#4ca1af", borderRadius: 2 }}/>
                  <span style={{ fontSize: "1rem", color: "#5a7a80", fontWeight: 500 }}>Advanced precision and care parameters</span>
                  <div style={{ width: 44, height: 3, background: "#4ca1af", borderRadius: 2 }}/>
                </div>
              </motion.div>
            </div>
